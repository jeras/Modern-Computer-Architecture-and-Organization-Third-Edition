...
# operation. a and b are the digits being subtracted
# (a - b), c is the carry: 0 = borrow, 1 = not borrow
def decrement_subtractor(a, b, c):
    a = (a - 1) % 10 # Decrement left operand, 9 if wrapped
...
# Subtract two decimal digits. The difference is returned
# as digit1 and the carry output is 0 (borrow) or 1
# (not borrow).
