...
# Answer
See the Python file [Ex__1_single_digit_adder.py](Code%20Files/Ex__1_single_digit_adder.py) for the adder code.

See the file [Ex__1_test_single_digit_adder.py](Code%20Files/Ex__1_test_single_digit_adder.py) for the test code.
