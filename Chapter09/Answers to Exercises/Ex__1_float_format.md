...
* The value `1.0e39f` is not shown because it causes a compile-time error: _The floating constant is out of range_.
...
* Numerically, subnormal floats use a biased exponent of 1, which translates to an unbiased exponent of -126.