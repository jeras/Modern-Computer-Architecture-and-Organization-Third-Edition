...
1. Create your assembly language source code within the **hello.s** file. See [Ex__3_riscv_expr.S](Code%20Files/Ex__3_riscv_expr.S) for an example solution to this exercise.
