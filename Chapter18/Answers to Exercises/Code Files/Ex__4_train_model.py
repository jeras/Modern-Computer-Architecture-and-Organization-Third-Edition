...
"""Ex__4_train_model.py: Answer to Ch 18 Ex 4."""
...
if __name__ == '__main__':
    training_images, training_labels, testing_images, \
        testing_labels = load_dataset()
    image_analysis_model = create_model()
    accuracy_history, test_accuracy = train_model(
        training_images, training_labels, testing_images,
        testing_labels, image_analysis_model)
    print()
    print('='*31)
    print('| Validation accuracy: {:.2f}% |'.
          format(100*test_accuracy))
    print('='*31)
    plot_model_accuracy(accuracy_history)
